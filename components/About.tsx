        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
          ...
          <div className="order-2 lg:order-1">
            <h2 className="text-4xl md:text-5xl font-bold font-heading text-metallo-navy mb-6 leading-tight">
              The Operating System for <span className="text-metallo-gold-hover">Industrial India</span>.
            </h2>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-3 gap-6 pt-6 border-t border-gray-200">
              <div className="flex flex-col gap-2 group cursor-default">
                <span className="material-symbols-outlined text-4xl text-metallo-navy group-hover:text-metallo-gold transition-colors">hub</span>
              ...
              <div className="flex flex-col gap-2 group cursor-default">
                <span className="material-symbols-outlined text-4xl text-metallo-navy group-hover:text-metallo-gold transition-colors">verified_user</span>
              ...
              <div className="flex flex-col gap-2 group cursor-default">
                <span className="material-symbols-outlined text-4xl text-metallo-navy group-hover:text-metallo-gold transition-colors">engineering</span>
