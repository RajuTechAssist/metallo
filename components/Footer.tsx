      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pt-12 pb-8">
        ...
        <div className="flex flex-col md:flex-row items-center justify-between mb-12 border-b border-gray-700/50 pb-8 gap-6">
            ...
            <div className="flex items-center space-x-4">
              {/* X (Twitter) */}
              <a href="#" className="bg-white text-metallo-navy hover:bg-metallo-gold transition-colors p-2 rounded-sm group">
            ...
            <div className="col-span-2 md:col-span-1">
                ...
                {status === 'success' ? (
                  <div className="bg-green-500/10 border border-green-500/20 rounded-lg p-6 mb-8 text-center animate-fade-in">
                    <span className="material-symbols-outlined text-green-500 text-3xl mb-2">mark_email_read</span>
                    <p className="text-white font-bold text-sm">Thanks for subscribing!</p>
                  </div>
                ) : (
                  <form onSubmit={handleSubscribe} noValidate>
                    ...
                    <div className="flex items-start gap-3 mb-8">
                      ...
                      />
                      <label htmlFor="consent" className={`text-xs leading-tight cursor-pointer transition-colors ${consent ? 'text-gray-300' : 'text-gray-400'}`}>
