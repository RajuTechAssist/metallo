...
const SLIDES: Slide[] = [
  ...
  },
  {
    ...
    image: 'https://images.unsplash.com/photo-1581092160562-40aa08e78837?w=1920&q=80&auto=format&fit=crop',
  ...
  },
  {
    ...
    image: 'https://images.unsplash.com/photo-1565193566173-7a0ee3dbe261?w=1920&q=80&auto=format&fit=crop',
  ...
  },
  {
    ...
    image: 'https://images.unsplash.com/photo-1581091226825-a6a2a5aee158?w=1920&q=80&auto=format&fit=crop',
...
const Hero: React.FC = () => {
  ...
  return (
    <section className="relative w-full mt-[97px] h-[calc(100vh-80px)] bg-slate-900 overflow-hidden">
      ...
      {/* ── Content ── */}
      <div className="relative z-10 flex flex-col justify-center h-full px-6 sm:px-12 lg:px-20 xl:px-28 pt-16 pb-40">
          ...
          <AnimatePresence mode="wait">
            <motion.div key={slide.id}>
              ...
              <div className="overflow-hidden mb-6">
                <motion.h1
                  className="text-5xl md:text-7xl lg:text-8xl font-heading font-extrabold text-white leading-[1.05] tracking-tight"
              ...
              >
                <Link
                  to={slide.link}
                  className="inline-flex items-center gap-3 px-8 py-4 bg-yellow-500 text-slate-900 text-sm font-heading font-extrabold uppercase tracking-wider hover:bg-yellow-400 transition-colors"
                >
      ...
      <div className="absolute bottom-0 inset-x-0 z-20 px-6 sm:px-12 lg:px-20 xl:px-28 pb-8 md:pb-10">
        <div className="flex items-end justify-between gap-6">

          {/* Left: Slide Counter + Progress Bar */}
          <div className="flex items-center gap-5 flex-1 max-w-md">
            {/* Numbers */}
            <div className="flex items-baseline gap-1 shrink-0">
              <span className="text-3xl md:text-4xl font-heading font-extrabold text-white tabular-nums">
                {slide.id}
              </span>
            ...
            {/* Progress Bar */}
            <div className="flex-1 h-[2px] bg-white/15 relative overflow-hidden">
              <motion.div
                key={progressKey}
