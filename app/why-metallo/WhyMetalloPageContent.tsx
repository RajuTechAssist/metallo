...
const ConvergingNode: React.FC<{ deg: number; icon: string; label: string }> = ({ deg, icon, label }) => {
  ...
  const x = 50 + radius * Math.cos(rad - Math.PI);
...
export default function WhyMetalloPageContent() {
               ...
               <ul className="space-y-8">
                 ...
                 <li className="flex gap-4">
                   ...
                   <div>
                     ...
                     <p className="text-sm text-gray-500">&ldquo;Equivalent&rdquo; brands often mean compromised specs.</p>
                   </div>
                 </li>
                 <li className="flex gap-4">
                   <span className="material-symbols-outlined text-red-500 shrink-0">close</span>
                   <div>
                     ...
                     <p className="text-sm text-gray-500">&ldquo;Material is on the way&rdquo; (but it hasn&apos;t left the warehouse).</p>
                   </div>
                 </li>
               </ul>
            </div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
           <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
              ...
              <div className="group">
                 ...
                 <h3 className="text-xl font-bold font-heading text-metallo-navy mb-2">The &ldquo;Power of One&rdquo;</h3>
              ...
              <div className="group">
                 ...
                 <h3 className="text-xl font-bold font-heading text-metallo-navy mb-2">&ldquo;Mission Critical&rdquo;</h3>
              ...
              <div className="group">
                 ...
                 <p className="text-sm text-gray-600 leading-relaxed">
                   We don&apos;t deal in &lsquo;unbranded&rsquo; quality. Steel: IS: 2062. Cables: IS: 7098. Welding: AWS Standards. Every shipment is accompanied by a Mill Test Certificate (MTC).
                 </p>
              </div>
