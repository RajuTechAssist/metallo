...
const Steel: React.FC = () => {
  ...
  const activeProduct =
    filteredProducts[activeProductIdx] || filteredProducts[0];
  ...
  const ProductButton: React.FC<{
    ...
    >
      ...
      <div className="min-w-0 flex-1">
        <span
          className={`block text-[13px] font-heading leading-tight truncate ${isActive ? "font-bold" : "font-semibold"}`}
        >
          {product["Product Name"]}
        </span>
        <span
          className={`block text-[10px] mt-0.5 ${isActive ? "text-slate-300" : "text-slate-400"}`}
        >
  ...
  return (
    <div className="w-full bg-slate-50" style={{ overflowX: "clip" }}>
      <ProductHero
        ...
        description="ASTM / ASME / API compliant Stainless, Carbon, Mild & Alloy Steel — engineered for critical infrastructure, oil & gas, and heavy engineering across 6 product families."
      ...
      <ProductCategoryNav
        ...
        certBadge="ASTM / ASME / API Certified"
      />
          ...
          <div className="flex flex-col lg:flex-row gap-6 lg:gap-8">
            ...
            <aside className="hidden lg:block w-[260px] xl:w-[300px] shrink-0">
              <div className="sticky" style={{ top: "64px" }}>
                ...
                <div
                  className="flex flex-col max-h-[calc(100vh-200px)] overflow-y-auto pr-1"
              ...
              <AnimatePresence mode="wait">
                {activeProduct && (
                  ...
                  >
                    ...
                    {activeProduct.Certification &&
                      activeProduct.Certification.length > 0 && (
                        <div className="mb-10">
                        ...
                        <div className="relative overflow-hidden rounded-sm h-[200px] md:h-[220px] lg:h-[260px] xl:h-[340px] group">
                          ...
                          <div className="absolute bottom-0 left-0 right-0 p-5">
                            <span className="inline-flex items-center gap-2 text-xs font-heading font-bold uppercase tracking-widest text-white/90 bg-slate-900/50 backdrop-blur-sm px-3 py-1.5 rounded-sm">
                              ...
                              {activeProduct.Application?.split(
                                ",",
                              )[0]?.trim() || "Industrial Application"}
                            </span>
                          </div>
                        </div>
                      </div>
        ...
        <div className="mx-auto container px-4">
          <div className="text-center mb-12">
            ...
            <h2 className="text-2xl md:text-3xl font-heading font-extrabold text-slate-900">
              Grades We Stock & Supply
            </h2>
            <p className="text-sm text-slate-500 font-sans mt-3 max-w-2xl mx-auto">
              Manufactured and supplied with full traceability. All grades
              available with Mill Test Certificates (EN 10204 3.1).
            </p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
            <div className="bg-white border border-slate-200 rounded-sm p-6 hover:shadow-md transition-shadow">
              <div className="flex items-center gap-2 mb-4">
                ...
                <h4 className="text-sm font-heading font-bold uppercase tracking-wider text-slate-900">
                  Stainless Steel
                </h4>
              </div>
              <div className="flex flex-wrap gap-1.5">
                {[
                  ...
                  <span
                    key={g}
                    className="px-2 py-0.5 bg-blue-50 border border-blue-100 text-blue-700 text-[11px] font-heading font-bold rounded-sm"
                  >
                    {g}
                  </span>
                ))}
            ...
            <div className="bg-white border border-slate-200 rounded-sm p-6 hover:shadow-md transition-shadow">
              ...
              <div className="flex flex-wrap gap-1.5">
                {[
                  ...
                  <span
                    key={g}
                    className="px-2 py-0.5 bg-slate-50 border border-slate-200 text-slate-700 text-[11px] font-heading font-bold rounded-sm"
                  >
                    {g}
                  </span>
                ))}
            ...
            <div className="bg-white border border-slate-200 rounded-sm p-6 hover:shadow-md transition-shadow">
              ...
              <div className="flex flex-wrap gap-1.5">
                {[
                  ...
                  <span
                    key={g}
                    className="px-2 py-0.5 bg-amber-50 border border-amber-100 text-amber-700 text-[11px] font-heading font-bold rounded-sm"
                  >
                    {g}
                  </span>
                ))}
            ...
            <div className="bg-white border border-slate-200 rounded-sm p-6 hover:shadow-md transition-shadow">
              ...
              <div className="flex flex-wrap gap-1.5">
                {[
                  ...
                  <span
                    key={g}
                    className="px-2 py-0.5 bg-violet-50 border border-violet-100 text-violet-700 text-[11px] font-heading font-bold rounded-sm"
                  >
                    {g}
                  </span>
                ))}
