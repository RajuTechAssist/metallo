    ...
    return (
        <div className="w-full bg-white">
            ...
            <section ref={heroRef} className="relative w-full overflow-hidden" style={{ height: '85vh', minHeight: '600px' }}>
                <motion.img
                    src="https://images.unsplash.com/photo-1486325212027-8081e485255e?w=1400&q=85&auto=format&fit=crop"
                    alt="Modern smart city skyline with urban infrastructure"
