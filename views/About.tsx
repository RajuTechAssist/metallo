  ...
  return (
    <div className="w-full bg-white">
      ...
      <section className="relative h-[60vh] min-h-[500px] flex items-center justify-center overflow-hidden">
        ...
        <div
          className={`relative z-10 flex flex-col justify-center ${CONTAINER}`}
        >
          <div className="max-w-4xl inset-0 bg-slate-900/60 pt-10 pb-10 pl-10 pr-10">
            <h1 className="text-2xl sm:text-3xl md:text-5xl font-heading font-bold text-white mb-4 md:mb-6 uppercase tracking-wide leading-tight">
              ...
              <br />
              <span className="text-metallo-gold">
            ...
            <p className="text-sm md:text-lg text-gray-300 max-w-3xl mb-8 md:mb-10">
              Delivering engineered metal solutions with precision, scale, and
              global reach.
            </p>
            <div className="flex flex-col sm:flex-row gap-4 justify-start">
              ...
              <Link
                href="/contact"
                className="px-8 py-4 bg-transparent text-white border-2 border-white font-bold font-heading uppercase tracking-wider hover:bg-white hover:text-metallo-navy transition-all shadow-xl"
              >
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
            <div>
              ...
              <div className="prose prose-lg text-gray-600 space-y-6 font-sans">
                <p>
                  Metallo is a modern manufacturing-technology platform built to
                  power the next generation of industrial infrastructure. We
                  integrate specialised manufacturing facilities, engineering
                  expertise, and global supply networks into a single
                  coordinated ecosystem that delivers high-performance
                  engineered materials worldwide.
                </p>
                <p>
                  Unlike traditional manufacturers limited by fixed factory
                  capacity, Metallo operates an asset-light distributed
                  production model. By connecting pipe mills, CNC machining
                  centres, fabrication units, and industrial assembly facilities
                  into a unified manufacturing network, we enable scalable
                  production while maintaining strict engineering and quality
                  standards.
                </p>
                <p>
                  This platform-driven approach allows Metallo to deliver
                  reliable industrial metal solutions—from stainless steel
                  piping systems to precision-engineered components—while
                  eliminating the bottlenecks that slow down industrial supply
                  chains.
                </p>
                <p className="font-bold text-metallo-navy">
                  Metallo was built to simplify industrial sourcing—bringing
                  together manufacturing capacity, engineering precision, and
                  global logistics into one seamless platform.
                </p>
              </div>
            </div>
      ...
      <section className="py-24 bg-gray-50">
        <div className={CONTAINER}>
          <div className="mb-16">
            <span className="text-metallo-gold-hover font-bold uppercase tracking-[0.2em] mb-3 text-sm font-heading block">
              The Metallo Platform Advantage
            </span>
            ...
            <p className="text-gray-600 text-lg leading-relaxed mb-4">
              Metallo operates a modern distributed manufacturing platform
              designed to eliminate the limitations of traditional factory-based
              production. Instead of relying on a single manufacturing facility,
              we integrate a network of specialised industrial
              partners—including pipe mills, CNC machining centres, fabrication
              units, and component manufacturers—into one coordinated production
              ecosystem.
            </p>
            <p className="text-gray-600 text-lg leading-relaxed">
              Through centralized raw material procurement, standardized
              production protocols, and digital production tracking, Metallo
              ensures consistent quality across every manufacturing partner.
              This asset-light platform architecture allows us to scale
              production rapidly, fulfill complex industrial orders efficiently,
              and deliver high-precision metal components without the
              bottlenecks of conventional manufacturing models.
            </p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 mb-12">
            ...
            <div className="bg-white p-8 border-b-4 border-metallo-gold hover:-translate-y-2 transition-transform duration-300 shadow-sm">
              <span className="material-symbols-outlined text-5xl text-metallo-navy mb-6">
                hub
              </span>
              <h3 className="text-xl font-bold font-heading text-metallo-navy uppercase mb-3">
                Networked Manufacturing Capacity
              </h3>
              <p className="text-sm text-gray-600">
                A coordinated ecosystem of specialized production facilities
                working as one unified manufacturing network.
              </p>
            </div>
            {/* Card 2 */}
            <div className="bg-white p-8 border-b-4 border-metallo-navy hover:-translate-y-2 transition-transform duration-300 shadow-sm">
              ...
              <p className="text-sm text-gray-600">
                Bulk material sourcing ensures consistent quality standards and
                cost efficiency across the entire production ecosystem.
              </p>
            </div>
            {/* Card 3 */}
            <div className="bg-white p-8 border-b-4 border-metallo-gold hover:-translate-y-2 transition-transform duration-300 shadow-sm">
              ...
              <p className="text-sm text-gray-600">
                Strict Standard Operating Procedures (SOPs) ensure consistent
                fabrication quality, dimensional accuracy, and material
                integrity.
              </p>
            </div>
            {/* Card 4 */}
            <div className="bg-white p-8 border-b-4 border-metallo-navy hover:-translate-y-2 transition-transform duration-300 shadow-sm">
              ...
              <p className="text-sm text-gray-600">
                Distributed manufacturing capacity enables rapid scaling for
                high-volume infrastructure and industrial projects.
              </p>
            </div>
          </div>
          ...
          <div className="text-left mt-12 bg-metallo-gold/10 inline-block px-8 py-4 border-l-4 border-metallo-gold">
            <p className="text-lg font-bold text-metallo-navy font-heading">
              Metallo transforms fragmented industrial capacity into a unified,
      ...
      <section className="py-24 bg-white">
        <div className={CONTAINER}>
          <div className="mb-16">
            <span className="text-metallo-gold-hover font-bold uppercase tracking-[0.2em] mb-3 text-sm font-heading block">
              Engineering Precision & Quality Assurance
            </span>
            <h2 className="text-3xl md:text-4xl font-bold font-heading text-metallo-navy mb-6">
              A Rigorous 3-Layer Quality Assurance System
            </h2>
            <p className="text-gray-600 text-lg leading-relaxed mb-4">
              Engineering precision and material reliability are fundamental to
              every product delivered by Metallo. To guarantee consistent
              performance across all industrial applications, we operate a
              structured 3-Layer Quality Assurance Process that verifies
              materials, manufacturing accuracy, and final product integrity.
            </p>
            <p className="text-gray-600 text-lg leading-relaxed">
              Every product—whether stainless steel piping systems, structural
              components, or precision fabricated assemblies—undergoes strict
              inspection and testing procedures designed to meet global
              engineering standards. Our quality control framework combines
              material certification verification, dimensional inspection, and
              advanced laboratory testing to ensure every component performs
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mb-16">
            <div className="relative bg-gray-50 p-8 border-t-4 border-metallo-gold">
              <div className="absolute -top-5 left-8 bg-metallo-navy text-white w-10 h-10 rounded-full flex items-center justify-center font-heading font-bold text-lg">
                1
              </div>
              <h3 className="text-xl font-bold font-heading text-metallo-navy uppercase mb-4 mt-4">
                Material Certification Verification
              </h3>
              <p className="text-sm text-gray-600">
                All raw materials are validated through manufacturer test
                certificates and third-party documentation before entering the
                production process, ensuring compliance with required material
            ...
            <div className="relative bg-gray-50 p-8 border-t-4 border-metallo-gold">
              ...
              <h3 className="text-xl font-bold font-heading text-metallo-navy uppercase mb-4 mt-4">
                Dimensional & Finishing Inspection
              </h3>
              <p className="text-sm text-gray-600">
                Our quality control teams perform detailed inspections of
                dimensions, tolerances, wall thickness, surface finishing, and
                product markings using calibrated inspection equipment.
              </p>
            </div>
            <div className="relative bg-gray-50 p-8 border-t-4 border-metallo-gold">
              <div className="absolute -top-5 left-8 bg-metallo-navy text-white w-10 h-10 rounded-full flex items-center justify-center font-heading font-bold text-lg">
              ...
              <p className="text-sm text-gray-600">
                Material samples undergo chemical and mechanical testing at
                NABL-accredited and ISO-certified laboratories to verify
                structural integrity and compliance with international
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 mb-16">
            <div className="bg-metallo-navy text-white p-10 rounded-sm">
              <h3 className="text-xl font-bold font-heading uppercase mb-6 text-metallo-gold">
                Advanced Testing Capabilities
              </h3>
              <p className="text-gray-300 text-sm mb-6">
                Metallo's quality assurance framework includes multiple in-house
                and third-party testing procedures to detect defects and verify
                product performance.
              </p>
            ...
            <div className="bg-gray-50 p-10 rounded-sm">
              <h3 className="text-xl font-bold font-heading uppercase mb-6 text-metallo-navy">
                Compliance & Certification
              </h3>
              <p className="text-gray-600 text-sm mb-6">
                Metallo operates under globally recognised quality standards and
                supports independent inspection by leading third-party agencies.
              </p>
              <ul className="space-y-4">
                <li className="flex items-start gap-3">
                  <span className="material-symbols-outlined text-metallo-gold mt-1">
                    verified
                  </span>
                ...
                <li className="flex items-start gap-3">
                  ...
                  <span className="text-gray-700">
                    Compliance with ASTM, ASME, DIN, and international
          ...
          <div className="text-left mt-12 bg-metallo-gold/10 inline-block px-8 py-4 border-l-4 border-metallo-gold">
            <p className="text-lg font-bold text-metallo-navy font-heading">
              Quality is not inspected into our products—it is engineered into
      ...
      <section className="py-24 bg-gray-50">
        <div className={CONTAINER}>
          <div className="mb-16">
            <span className="text-metallo-gold-hover font-bold uppercase tracking-[0.2em] mb-3 text-sm font-heading block">
              Global Supply Chain & Project Delivery
            </span>
            <h2 className="text-3xl md:text-4xl font-bold font-heading text-metallo-navy mb-6">
              Delivering Metal Solutions — Globally and Locally
            </h2>
            <p className="text-gray-600 text-lg leading-relaxed mb-4">
              Metallo simplifies complex industrial sourcing through an
              integrated global supply chain designed for reliability, speed,
              and efficiency. By combining international manufacturing
              partnerships with strategically coordinated logistics, we ensure
              that critical engineering materials reach project sites on time—no
              matter where they are in the world.
            </p>
            <p className="text-gray-600 text-lg leading-relaxed">
              Today, Metallo exports engineered metal products to more than 29
              countries across multiple continents, supporting large-scale
              infrastructure, energy, and industrial manufacturing projects. Our
              global logistics network enables us to deliver both standard
              industrial materials and custom-engineered assemblies with
              consistent quality and dependable delivery timelines.
            </p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 mb-16">
            <div className="bg-white p-8 border-b-4 border-metallo-gold hover:-translate-y-2 transition-transform duration-300 shadow-sm">
              ...
              <p className="text-sm text-gray-600">
                Metallo maintains a strong international presence through
                strategic partnerships and regional distribution capabilities,
                supporting customers across global infrastructure and
            ...
            <div className="bg-white p-8 border-b-4 border-metallo-navy hover:-translate-y-2 transition-transform duration-300 shadow-sm">
              ...
              <p className="text-sm text-gray-600">
                To enable rapid dispatch and reduced transit times, we maintain
                stock with trusted logistics partners across key global
                locations including the United States, Europe, and Singapore.
              </p>
            </div>
            <div className="bg-white p-8 border-b-4 border-metallo-gold hover:-translate-y-2 transition-transform duration-300 shadow-sm">
              <span className="material-symbols-outlined text-5xl text-metallo-navy mb-6">
              ...
              <p className="text-sm text-gray-600">
                Our export infrastructure supports high-volume shipments,
                specialized packaging, and coordinated logistics management for
            ...
            <div className="bg-white p-8 border-b-4 border-metallo-navy hover:-translate-y-2 transition-transform duration-300 shadow-sm">
              ...
              <h3 className="text-xl font-bold font-heading text-metallo-navy uppercase mb-3">
                Project Export Expertise
              </h3>
              <p className="text-sm text-gray-600">
                Metallo manages complex project exports by coordinating
                multi-product shipments, logistics planning, and delivery
                schedules for large industrial and infrastructure projects.
              </p>
            </div>
          </div>
          ...
          <div className="bg-metallo-navy text-white p-10 rounded-sm mb-12">
            <h3 className="text-xl font-bold font-heading uppercase mb-4 text-metallo-gold">
              Compliance & Logistics Efficiency
            </h3>
            <p className="text-gray-200 leading-relaxed mb-3">
              Metallo holds Authorized Economic Operator (AEO) status, enabling
              faster customs clearance, improved port handling efficiency, and
              streamlined international trade processes.
            </p>
            <p className="text-gray-300 leading-relaxed">
              This certification allows us to minimize logistical delays and
              ensure reliable delivery schedules for time-critical
          ...
          <div className="text-left mt-12 bg-metallo-gold/10 inline-block px-8 py-4 border-l-4 border-metallo-gold">
            <p className="text-lg font-bold text-metallo-navy font-heading">
              From raw material sourcing to global project delivery, Metallo
              ensures your supply chain moves without interruption.
            </p>
          </div>
        </div>
      </section>
        ...
        <div className={CONTAINER}>
          <div className="grid grid-cols-1 md:grid-cols-2 gap-12 divide-y md:divide-y-0 md:divide-x divide-white/20 mb-16">
            ...
            <div className="pr-0 md:pr-12">
              ...
              <p className="text-lg text-gray-300 mb-6 leading-relaxed">
                Our vision is to be the world's most trusted industrial
                manufacturing platform — uniting engineering innovation,
                distributed manufacturing capacity, and global logistics to
                power the future of infrastructure. We aim to lead across
                multiple verticals (steel, electrical support systems, precision
                components, and industrial technology), while advancing
                sustainable practices, global standards compliance, and
                dependable project exports.
              </p>
              <p className="text-2xl md:text-3xl font-serif leading-relaxed text-white/90 italic">
                "To be the trusted global platform for engineered industrial
                solutions."
              </p>
            </div>
            ...
            <div className="pt-12 md:pt-0 pl-0 md:pl-12">
              <h3 className="text-metallo-gold text-lg font-bold uppercase tracking-widest mb-6 font-heading flex items-center gap-2">
                <span className="material-symbols-outlined">flag</span> The
                Mission
              </h3>
              <p className="text-lg text-gray-300 mb-6 leading-relaxed">
                Our mission is to simplify industrial sourcing and manufacturing
                by building a connected ecosystem of manufacturers, suppliers,
                and engineering expertise. We combine centralized procurement,
                standardized production processes, and digital supply-chain
                visibility to deliver reliable, high-quality industrial products
                and customised fabrication solutions — on time and to
                specification. We partner with customers as engineering
                collaborators, using modern manufacturing technologies and
                rigorous quality controls to reduce risk and accelerate project
                delivery.
              </p>
              <p className="text-2xl md:text-3xl font-serif leading-relaxed text-white/90 italic">
                "Simplifying industrial sourcing through connected manufacturing
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8">
            <div className="flex flex-col items-center md:items-start text-center md:text-left bg-white/5 p-6 rounded-sm">
              <span className="material-symbols-outlined text-4xl text-metallo-gold mb-4">
                verified
              </span>
              <h4 className="text-lg font-bold font-heading uppercase mb-2">
                Quality & Compliance
              </h4>
              <p className="text-gray-400 text-sm">
                ISO-driven processes, NABL lab testing, and third-party
                inspections to meet ASTM/ASME/DIN standards.
              </p>
            </div>
            <div className="flex flex-col items-center md:items-start text-center md:text-left bg-white/5 p-6 rounded-sm">
              <span className="material-symbols-outlined text-4xl text-metallo-gold mb-4">
              ...
              <p className="text-gray-400 text-sm">
                Asset-light distributed manufacturing that scales to meet large
                project demands.
              </p>
            </div>
            <div className="flex flex-col items-center md:items-start text-center md:text-left bg-white/5 p-6 rounded-sm">
              ...
              <p className="text-gray-400 text-sm">
                Engineering support, technical selection guidance, and turnkey
            ...
            <div className="flex flex-col items-center md:items-start text-center md:text-left bg-white/5 p-6 rounded-sm">
              ...
              <p className="text-gray-400 text-sm">
                Responsible procurement and production practices that minimize
                waste and support long-term industrial resilience.
              </p>
            </div>
          </div>
        </div>
      ...
      <section className="py-24 bg-white">
        <div className={CONTAINER}>
          <div className="mb-16">
            <span className="text-metallo-gold-hover font-bold uppercase tracking-[0.2em] mb-3 text-sm font-heading block">
              Why Industry Leaders Choose Metallo
            </span>
            <h2 className="text-3xl md:text-4xl font-bold font-heading text-metallo-navy mb-6">
              Engineering Precision. Scalable Manufacturing. Reliable Delivery.
            </h2>
            <p className="text-gray-600 text-lg leading-relaxed">
              Metallo combines engineering expertise, distributed manufacturing
              capacity, and strict quality control systems to deliver reliable
              industrial metal solutions at scale. Our platform-driven approach
              enables faster production, consistent material quality, and
              dependable supply chains for complex infrastructure and industrial
              projects.
            </p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 mb-12">
            <div className="bg-gray-50 p-8 border-b-4 border-metallo-gold hover:-translate-y-2 transition-transform duration-300">
              ...
              <h3 className="text-xl font-bold font-heading text-metallo-navy uppercase mb-3">
                Distributed Manufacturing Platform
              </h3>
              <p className="text-sm text-gray-600">
                Our network of specialized manufacturing partners allows us to
                scale production capacity quickly while maintaining strict
                engineering standards.
              </p>
            </div>
            <div className="bg-gray-50 p-8 border-b-4 border-metallo-navy hover:-translate-y-2 transition-transform duration-300">
              ...
              <p className="text-sm text-gray-600">
                Centralized raw material sourcing and standardized operating
                procedures ensure consistent fabrication quality, dimensional
                accuracy, and material integrity across our manufacturing
                ecosystem.
              </p>
            </div>
            <div className="bg-gray-50 p-8 border-b-4 border-metallo-gold hover:-translate-y-2 transition-transform duration-300">
              ...
              <p className="text-sm text-gray-600">
                Our rigorous 3-Layer Quality Assurance Process includes
                dimensional inspection, material certification verification, and
                advanced laboratory testing using hydrostatic, ultrasonic, eddy
                current, and PMI testing methods.
              </p>
            </div>
            <div className="bg-gray-50 p-8 border-b-4 border-metallo-navy hover:-translate-y-2 transition-transform duration-300">
              <span className="material-symbols-outlined text-5xl text-metallo-navy mb-6">
              ...
              <p className="text-sm text-gray-600">
                We collaborate with NABL-accredited laboratories and support
                third-party inspections from internationally recognized agencies
                to ensure compliance with global engineering standards.
              </p>
            </div>
          </div>
          ...
          <div className="text-left mt-12 bg-metallo-gold/10 inline-block px-8 py-4 border-l-4 border-metallo-gold">
            <p className="text-lg font-bold text-metallo-navy font-heading">
              Metallo delivers engineering-grade reliability across every stage
        ...
        <div className={CONTAINER}>
          <div className="mb-10">
            ...
            <p className="text-gray-600 text-base leading-relaxed">
              Metallo's engineered metal solutions are designed to support
              mission-critical infrastructure, manufacturing, and energy
              projects across a wide range of industrial sectors. Our products
              are built to perform in demanding environments where durability,
              reliability, and engineering precision are essential.
            </p>
          </div>
          ...
          >
            ...
            {/* Railways & Defence */}
            <Link
              href="/industries/railways-defence"
              className="group relative flex-shrink-0 w-[160px] h-[220px] md:w-[180px] md:h-[240px] lg:w-auto lg:h-[260px] rounded-md overflow-hidden cursor-pointer block"
            >
              <Image
