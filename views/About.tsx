        ...
        <div className={`relative z-10 flex flex-col justify-center ${CONTAINER}`}>
          <div className='max-w-4xl inset-0 bg-slate-900/60 pt-10 pb-10 pl-10 pr-10'>
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-start">
              ...
              <Link href="/contact" className="px-8 py-4 bg-transparent text-white border-2 border-white font-bold font-heading uppercase tracking-wider hover:bg-white hover:text-metallo-navy transition-all shadow-xl">
